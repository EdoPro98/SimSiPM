...
public:
  ...
  */
  ...
  /** Used to get the generated signal from the sensor. This method should be run
  * after @ref runEvent otherwise it will return only electronic noise.
  */
  ...
  */
  ...
  /** Sets a SiPM property using its name. For a list of available SiPM properties
  * names @sa SiPMProperties
  */
...
private:
  ...
  */
  ...
  /** Dark counts events are generated as poisson processes and directly added to
  * the list of hitted cells.
  */
  void addDcrEvents();
  ...
  * afterpulses. Each afterpulse is delayed from the generating signal following
  * a slow/fast exponential distribution.
  */
  void addApEvents();
  /// @brief Calculates signal amplitudes for all hits
  /** Each hit has a starting amplitude of 1 but if the same cell has been
  * previously hitted the resulting amplitude will be calculated considering the
  * cell as an RC circuit, hence:
